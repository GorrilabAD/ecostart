            ...
            c = {
                ...
                init: function() {
                    if (null === this.current) {
                        var t = this.systemLang.split("-")[0];
                        "undefined" === this.available[t] ? this.current = "en" : this.current = t, localStorage.setItem("lang", this.current)
                    }
                    this.load()
                },
                load: function() {
                ...
                change: function(t) {
                    "undefined" !== this.available[t] && (localStorage.setItem("lang", t), this.current = t, this.load())
                },
                get: function(t, a) {
                    return void 0 !== this.data[t] && void 0 !== this.data[t][a] ? "titles" === t ? this.data[t][a] + " | EcoStart" : this.data[t][a] : "titles" === t ? a + " | INCERIO" : a
                },
                data: {}
            };
        c.init();
